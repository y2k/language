...
(defn test []
  ...
  (assert_ __LOC__ true (clojure.string/starts-with? "hello world" "hello"))
  (assert_ __LOC__ false (clojure.string/starts-with? "hello world" "world"))
  ...
  (assert_ __LOC__ true (clojure.string/starts-with? "abc" "ab"))
  ...
  (assert_ __LOC__ "a b" (clojure.string/join " " ["a" "b"]))
  (assert_ __LOC__ 42 (:b (assoc {:a 1 :b 2 :c 3} :b 42)))
  (assert_ __LOC__ 99 (:d (assoc {:a 1} :d 99)))
  (assert_ __LOC__ [1 2 3] (take 3 [1 2 3 4 5]))
  (assert_ __LOC__ [1 2] (take 2 [1 2]))
  (assert_ __LOC__ [] (take 0 [1 2 3]))
  (assert_ __LOC__ [4 5] (drop 3 [1 2 3 4 5]))
  (assert_ __LOC__ [] (drop 2 [1 2]))
  (assert_ __LOC__ [1 2 3] (drop 0 [1 2 3]))
  0)
